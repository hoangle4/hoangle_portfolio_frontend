                ...
                <div className='row p-0 m-0'>
                  ...
                  <div className='col-md-6 text-dark'>
                    <div className="card-body">
                      <a href="#" style={{ background :'#20c997',
                        color :'white',
                        fontSize :'1.6rem' }} className="btn mb-3"><i className="far fa-plus-square" /></a>
                  ...
                  <div className='col-md-6 text-dark'>
                    <div className="card-body">
                      <a href="#" style={{ background :'#3498DB',
                        color :'white',
                        fontSize :'1.6rem' }} className="btn mb-3"><i className="far fa-share-square" /></a>
